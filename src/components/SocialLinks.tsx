...
const SocialLinks: React.FC<{ page?: string }> = ({ page }) => {
  ...
  const socialLinks = [
    {
      title: data.account.fullname + "'s Github Profile",
    ...
    {
      title: data.account.fullname + "'s LinkedIn Profile",
    ...
    {
      title: "Check " + data.account.fullname + " on Dev.to",
      link: data.socials.devto,
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    {
      title: data.account.fullname + "'s Profile on Telegram",
