...
const BlogCardBox: React.FC<Props> = ({
  ...
  return (
    <li
      className={`blog-card-box sm:min-w-[17rem] bg-gray-100 dark:bg-carddark p-4 rounded shadow hover:shadow-md ${fullWH ? "w-full" : "w-72 my-2"
        } ${className}`}
    >
      <div className="mb-2">
      ...
      <p
        className={`dark:text-gray-300 ${fullWH ? "text-base sm:text-sm" : "text-sm w-60"
          } overflow-hidden`}
      >
        {excerpt}
      </p>
