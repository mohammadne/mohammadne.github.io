    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a Software Enginner with a passion for delivering exceptional results.
          </p>
          <p>
            With my experience in Backend and Cloud development specially using Go,
            python, Bash, Lua and Rust, I bring a unique combination of technical
            skills and creative problem-solving to every project I work on.
          </p>
        </div>
